...
Uses the ingestion module (Parsing Team) for layout-aware extraction
with pdfplumber for text-based PDFs and pytesseract + pdf2image
for scanned documents. Exposes a ParsedDocument interface for the
extraction pipeline.
"""
